...
import { MoreHorizontal, Plus, ArrowLeft, Trash2, Layout, CheckSquare } from 'lucide-react';
...
export const BoardView = () => {
    ...
    const [activeView, setActiveView] = useState<'board' | 'checklist'>('board');
    ...
    return (
        <div className="bg-board-bg flex-1 flex flex-col overflow-hidden">
            <div className="py-4 px-6 bg-white/40 flex items-center gap-4">
                ...
                <div className="ml-auto flex bg-white/50 p-1 rounded-lg border border-gray-200">
                    <button
                        onClick={() => setActiveView('board')}
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all border-none cursor-pointer ${activeView === 'board' ? 'bg-white shadow-sm text-primary' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                        <Layout size={16} />
                        Board
                    </button>
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all border-none cursor-pointer ${activeView === 'checklist' ? 'bg-white shadow-sm text-primary' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                        <CheckSquare size={16} />
                        Checklist
                    </button>
